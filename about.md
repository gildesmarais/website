...
<main class="about">
  ...
  <p>
    ...
    And of course, I write tests to ensure the code is working as
    intended.
  </p>

  <p>
    In my spare time, I enjoy baking and cooking, listening to and making music,
    riding the bike, reading aviation news or visiting user groups, like the
    <a href="http://rug-b.de" target="_blank">
      RUG::B.
    </a>
  </p>
  
  <p>
    After serving the military, I studied Business Computing and
    started working full time in 2011.
    By now, I wrote code for young and older startups, an agency and my side
