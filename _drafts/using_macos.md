...
The macOS' Finder app is an ironic joke. Apple does not seem to care much about it. [^6]I can't find anything with it, it just stands in the way. It's barely usable with a keyboard. The (unchangeable) hotkeys are weird (Return to start renaming?! What?). To work effectively with it you have to move the cursor. Instant disqualification.[^7]
