...
Luckily, there's [Marta](https://marta.yanex.org/), a two pane file manager, like the Norton Commander in the good old days (not the stone age). Has a fuzzy search/lookup relative to `cwd` with Ctrl</kbd>+<kbd>P</kbp>.
