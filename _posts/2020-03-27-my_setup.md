...
- the old  trackpad
- the old  wireless keyboard with "International Layout"
- a laptop stand to move the machine above the layer where fluids are placed
- a desk-pad

I prefer a  Macbook Air or Pro as my main working machine. With such machine I can also work temporarily when not being at a fully equipped desk.

Usually I'm wearing a Bose QC15 headphone with Airmod for bluetooth connectivity. The headphones are with me for seven years. I use them daily, at least 6 hours a working day. They are in a surprisingly good state without any defects. Some parts wear out, so I've replaced the ear cushions multiple times and the headband once with after market parts for a few bucks. They are super comfortable and run with one AAA batteries (!).

## How I work

Touching the the trackpad to move the cursor is a flaw I try to avoid at any time. It's time-intensive and puts a strain on your wrist. Keeping the hands at the keyboard gives you all the power you'd ever want.
...
To keep my thoughts or quickly prototype a UI, I swear on a DIN A5 sketchbook (with at least 150g/m^2 paper) and a mechanical pencil with 0.5mm B lead.

I listen to electronic music mixes mostly. A favorite source of fresh music
is the BBC Radio 1 Essential Mix. Depending on my mood on the day, I choose one of ~20 all-time favorites.
I regularly listen to the same mixes. The purpose is to not have any surprise moments while getting into **the flow**. I also find Pete Tong's voice introducing every mix very soothing (I've you're reading this, Pete: Heya 👋).
