...
To keep my thoughts or quickly prototype a UI, I swear on a DIN A5 sketchbook (with at least 150g/m^2 paper) and a mechanical pencil with 0.5mm B pencil lead.
...
Here's the Applications and tool I've running all day:
...
However, I'll check out [FSNotes](), which looks very promising, soon.
