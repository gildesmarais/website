...
export default (data: Lume.Data, helpers: Lume.Helpers) => (
  <div className="h-card index" id="hcard-Gil-Desmarais">
    <h1>
      <span className="p-name">Gil Desmarais</span>
    ...
    <p>
      <span className="p-job-title">full stack developer</span> &ndash;
      <span className="p-locality">Berlin</span>, GER
    </p>
    ...
    <p>
      ...
      <br />
      I like to <a href="/movie_ratings/">rate and review movies</a>.
    </p>
