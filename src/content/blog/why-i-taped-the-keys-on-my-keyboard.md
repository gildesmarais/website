...
For a while I struggled to press the correct key in the number row. There's no indicator like on the F and J keys. With time I became more precise, but you can't fully make up the missing indicators.

![A photo of my taped keyboard](../../assets/images/posts/2020-03-27-keyboard.webp)

I ran out of labels to also tape the function-key row and some modifier keys. The modifier keys I know in and out. Pressing one of the function keys is a well-considered operation IMHO. When pressing one, I look at the keyboard, press that key, and wait for the function to trigger.
